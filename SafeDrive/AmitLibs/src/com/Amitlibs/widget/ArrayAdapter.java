...
/**
 * A concrete BaseAdapter that is backed by an array of arbitrary objects. By default this class expects that the provided resource id references a single TextView. If you want to use a more complex
 * layout, use the constructors that also takes a field id. That field id should reference a TextView in the larger layout resource.
 * <p/>
 * <p/>
 * However the TextView is referenced, it will be filled with the toString() of each object in the array. You can add lists or arrays of custom objects. Override the toString() method of your objects
 * to determine what text will be displayed for the item in the list.
 * <p/>
 * <p/>
 ...
 * {@link #getView(int, View, ViewGroup)} to return the type of view you want.
 */
public class ArrayAdapter<T> extends BaseAdapter implements Filterable {
    ...
    /**
     * Lock used to modify the content of {@link #mObjects}. Any write operation performed on the array should be synchronized on this lock. This lock is also used by the filter (see
    ...
    /**
     * If the inflated resource is not a TextView, {@link #mFieldId} is used to find a TextView inside the inflated views hierarchy. This field must contain the identifier that matches the one defined
     ...
     * @param objects
     */
    public ArrayAdapter(Context context, int resource, ArrayList<T> objects) {
    ...
    /**
     * Control whether methods that change the list ({@link #add}, {@link #insert}, {@link #remove}, {@link #clear}) automatically call {@link #notifyDataSetChanged}. If set to false, caller must
    ...
    public T getItem(int position) {
        if (position < mObjects.size() && position != mObjects.size() )
